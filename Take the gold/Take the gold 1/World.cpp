...
void World::CreateWorld(){
	...
	// ---------------------------------------------------------------------------------------------------------------
	// Katana
	worldexternpointer->entities.pushback(new Item("Rusty Katana", "This is the ancient rusty katana of a japanese guy, but still sharpened.", (Room*)worldexternpointer->entities[6], 35, 0, 1000, false, false, true, true, false, false, ITEM, 200));
	// Gas Mask
	worldexternpointer->entities.pushback(new Item("Gas Mask", "This gas mask can save you from toxic gases.", (Room*)worldexternpointer->entities[7], 0, 0, 1000, false, false, true, true, false, false, ITEM, 100));
	// Treasure
	worldexternpointer->entities.pushback(new Item("Treasure", "Your goal, the mighty treasure of the king.", (Room*)worldexternpointer->entities[8], 0, 0, 0, false, false, false, true, false, false, ITEM, 10000));
	// Venom Gas Granade
	worldexternpointer->entities.pushback(new Item("Venom Gas Grenade", "Usefull against big groups of enemies, but you should search a gas mask to use it safely.", (Room*)worldexternpointer->entities[5], 100, 0, 2, false, false, false, true, false, false, ITEM, 100));
	// Sword
	worldexternpointer->entities.pushback(new Item("Sword", "Fullmetal sharpened sword, kill enemies with 2 hits.", (Room*)worldexternpointer->entities[2], 50, 0, 1000, false, false, true, true, false, false, ITEM, 300));
	// Shield
	worldexternpointer->entities.pushback(new Item("Shield", "Protect you from enemy attacks.", (Room*)worldexternpointer->entities[2], 0, 75, 1000, false, false, true, true, false, false, ITEM, 200));
	// Explosive
	worldexternpointer->entities.pushback(new Item("Explosive", "You can blow the treasure wall with that.", (Room*)worldexternpointer->entities[3], 1000, 0, 1000, false, false, false, true, false, false, ITEM, 500));
	// Key
	worldexternpointer->entities.pushback(new Item("Key", "Key of tower 4.", nullptr, 1, 0, 1, false, false, false, false, false, true, ITEM, 100));//seller have it
	// Backpack
	worldexternpointer->entities.pushback(new Item("Backpack", "Box to keep items inside.", (Room*)worldexternpointer->entities[1], 5, 0, 1000, false, false, false, false, false, false, ITEM, 150));
